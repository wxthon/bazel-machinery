...
load("@bazel_machinery//tools/utils:generate_file.bzl", "generate_file")
load("@bazel_machinery//tools/utils:template_file.bzl", "template_file")
...
#define _CUSTOM_HAL_INCLUDED_
    ...
    generate_file(
        ...
        content = select({
            ...
            _format_config("aarch64", config.get("opts", [])),
