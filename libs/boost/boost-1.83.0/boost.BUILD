...
load("@bazel_machinery//libs/boost/boost-1.83.0:boost.bzl",
     "boost_library", "boost_so_library", "default_copts", "default_defines", "hdr_list")
...
boost_library(
    name = "asio",
    srcs = [
        "@bazel_machinery//libs/boost/boost-1.83.0/src:build_asio.cpp",
    ],
    defines = [
...
cc_library(
    name = "asio_ssl",
    srcs = [
        "@bazel_machinery//libs/boost/boost-1.83.0/src:build_asio_ssl.cpp",
    ],
    visibility = ["//visibility:public"],
    deps = [
        ":asio",
...
boost_library(
    name = "beast",
    srcs = [
        "@bazel_machinery//libs/boost/boost-1.83.0/src:build_beast.cpp",
    ],
    defines = [
