...
autoconf_config = rule(
    attrs = {
        ...
        "autoconf_config_gen": attr.label(
            cfg = "host",
            executable = True,
            default = Label("@bazel_machinery//tools/autoconf:autoconf_config_gen"),
        ),
    },
...
#    "HAVE_INOTIFY_INIT1",
    ...
    "@bazel_machinery//conditions:long_double_16bytes" : [
        "SIZEOF_LONG_DOUBLE=16",
    ],
    "@bazel_machinery//conditions:long_double_8bytes" : [
        "SIZEOF_LONG_DOUBLE=8",
    ],
}) + select({
    "@bazel_machinery//conditions:long_8bytes" : [
    ...
    "@bazel_machinery//conditions:long_4bytes" : [
    ...
    "@bazel_machinery//conditions:sizet_8bytes" : [
        "SIZEOF_SIZE_T=8",
        "SIZEOFSSIZE_T=8",
    ],
    "@bazel_machinery//conditions:sizet_4bytes" : [
        "SIZEOF_SIZE_T=4",
        "SIZEOFSSIZE_T=4",
    ],
}) + select({
